...
export default function Home() {
  ...
  const [renderPopCourses, setRenderPopCourses] = useState(true);
  ...
  return (
    ...
    >
      ...
      <Formik
        ...
        onSubmit={(value) => {
          console.log(value);
          navigation.navigate("CoursesList", { subject: value.searchText });
        }}
      >
        {(props) => (
            ...
            >
              ...
              <View style={homeStyles.courseInfoContainer}>
                ...
                <View style={homeStyles.courseSubInfoContainer}>
                  <Text style={homeStyles.courseInfoText}>
                    {item.tutor_name}
                  </Text>
                  <Text style={homeStyles.courseInfoText}>
                  ...
                  <View style={homeStyles.courseScoreContainer}>
                    ...
                    <Text
                      style={{ ...homeStyles.courseInfoText, fontSize: 16 }}
                    >
                      {" (" + item.rated_num + ")"}
                    </Text>
                  </View>
                  ...
                  {false ? (
                    <View style={homeStyles.coursePriceContainer}>
                      ...
                      <Text
                        style={{ ...homeStyles.coursePrice, color: "#22c736" }}
                      >
                        {"已購買"}
                      </Text>
                    </View>
      ...
      <View style={globalStyles.homeVerticalFooter}></View>
    </ScrollView>
  );
}
